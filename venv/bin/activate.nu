...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/paulvalladares/PycharmProjects/portfo-flask/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/paulvalladares/PycharmProjects/portfo-flask/venv/bin/deactivate.nu'
